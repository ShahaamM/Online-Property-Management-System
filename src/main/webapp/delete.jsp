			...
			<div class="container-fluid sectionClasss">
				...
				<div class="container">
					...
					<form method="post" action="delete">
						...
						<div class="row">
							<div class="col-md-12">
								<h2 class="text-center text-white font-weight-bold" style="font-size: 50px;">Delete Carefully</h2>
							</div>


							<div class="row">
								<div class="col-md-4 labels text-white font-weight-bold">User Id</div>
								<div class="col-md-4">
