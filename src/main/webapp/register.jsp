			...
			<div class="container-fluid sectionClasss">
						...
						<div class="col-6">
							<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
								...
								<ul
									...
									<li class="nav-item"><a class="nav-link nav-btn"
										aria-current="page" href="login.jsp">Log In</a></li>
				...
				<div class="container">
					...
					<form method="post" action="Register">
						...
						<div class="row">
							<div class="col-md-12">
								<h2 class="text-center text-white font-weight-bold" style="font-size: 50px;">Please Register</h2>
							</div>


							<div class="row">
								<div class="col-md-4 labels text-white font-weight-bold">Full Name</div>
								<div class="col-md-4">
							...
							<div class="row">
								<div class="col-md-8 text-center">
									<button type="submit" class="btn btn-success btn-lg btn-block btn-donate">
										Register</button>
								</div>
								<div class="col-md-2"></div>
							</div>
