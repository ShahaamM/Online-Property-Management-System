...
<div class="col-md-4 labels text-white font-weight-bold"><h1>Welcome <%= session.getAttribute("username") %></h1></div>

<div class="col-md-4 labels text-white font-weight-bold">
...
<table style="width:100%" >
  ...
  <tr>
    <td>Name</td>
    <td><%= session.getAttribute("full_name") %></td>
...
<button type="submit" class="btn btn-success btn-sm btn-block">
  <a href="update.jsp" style="color:black;text-align:center;text-decoration:none;">Update</a>
</button>

<button type="submit" class="btn btn-success btn-sm btn-block">
  <a href="delete.jsp" style="color:black;text-align:center;text-decoration:none;">Delete</a>
</button>
</div>
